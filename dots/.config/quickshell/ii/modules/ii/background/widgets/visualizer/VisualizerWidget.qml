...
AbstractBackgroundWidget {
    ...
    // No shared global audio-levels bus exists in ii-vynx (MediaWidget runs its own
    // local cava process for its embedded visualizer too), so this widget reads
    // levels from its own cava instance rather than a nonexistent GlobalStates source.
