    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: StyledText {
                ...
                color: dropArea.containsDrag ? Appearance.colors.colPrimary : rootItem.highlighted ? Appearance.colors.colOnPrimary : Bar.BarPalette.foreground(Appearance.colors.colOnSurface)
