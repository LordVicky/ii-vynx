    ...
    lazyContent: Component {
        ColumnLayout {
            ...
            function getUpcomingTodos(todos) {
                ...
                let todoText = limitedTodos.map(function (item) {
                    return `  • ${item.content}`;
                }).join('\n');
            ...
            HeroCard {
                ...
                title: columnLayout.formattedTime
                subtitle: columnLayout.formattedDate
            ...
            ColumnLayout {
                ...
                InfoPill {
                    ...
                    icon: TimerService.pomodoroBreak ? "coffee" : columnLayout.stopwatchPaused ? "timer_pause" : TimerService.stopwatchRunning ? "timer_play" : "timer"
                }
            ...
            Component {
                ...
                StyledText {
                    ...
                    text: columnLayout.formatTimerDisplay(TimerService.pomodoroSecondsLeft)
                    font.pixelSize: Appearance.font.pixelSize.large
                    font.family: Appearance.font.family.title
                    font.weight: Font.Bold
                }
            ...
            Component {
                ...
                RowLayout {
                    ...
                    SequentialAnimation {
                        running: columnLayout.stopwatchPaused
                        loops: Animation.Infinite

                        ScriptAction {
                            script: textLayout.visible = true
                        }
                        PauseAnimation {
                            duration: 700
                        }
                        ScriptAction {
                            script: textLayout.visible = false
                        }
                        PauseAnimation {
                            duration: 700
                        }
            ...
            Component {
                ...
                SectionCard {
                    ...
                    icon: "checklist"
                    subtitle: columnLayout.todosSection

                    LoadingPlaceholder {
                        Layout.preferredHeight: 30
                        visible: columnLayout.todosEmpty
                        loading: false
